...
Run:  python notebooks/build/build_colab_notebook.py   (writes notebooks/colab/)
"""
import json, os, re, sys, textwrap, hashlib
...
OUT = os.path.join(ROOT, "notebooks", "colab", "QI_MRFO_DMO_Colab.ipynb")
