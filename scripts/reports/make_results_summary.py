...
Needs reportlab (pip install reportlab; not part of the pinned experiment environment).  python scripts/reports/make_results_summary.py
"""
import os, sys
...
OUT = os.path.join(ROOT, "docs", "summaries", "results_summary.pdf")
