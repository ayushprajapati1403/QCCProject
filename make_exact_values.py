...
Needs reportlab (pip install reportlab).  python make_exact_values.py
"""
import json
import os
import numpy as np
...
from make_results_summary import S, table, RES, HERE          # registers the fonts and shares the table style
from qi_dynamic import make_dynamic_sequence

OUT = os.path.join(HERE, "results_exact_values.pdf")
