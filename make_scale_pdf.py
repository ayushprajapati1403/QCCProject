...
Needs reportlab (pip install reportlab).  python make_scale_pdf.py
"""
import os, sys
import numpy as np
import pandas as pd
...
from make_results_summary import S, table, RES, HERE
from exp_scale_tasks import SIZES, ALGOS, LABELS, M

OUT = os.path.join(HERE, "results_scale_tasks.pdf")
